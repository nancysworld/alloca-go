...
//
// The other measurement-contract §12 rules need a database and are exercised by the
// integration suite; this one needs neither, and testing it through Run would make a
// comparison of two in-memory totals depend on a running PostgreSQL — which is how a cheap
// test becomes one nobody runs.
