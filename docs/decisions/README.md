...
Planned (not yet written): `0004` capacity-unit selection, if and when capacity economics is
selected as a Goal (see the exploration roadmap). It was pencilled in as `0003` before that
