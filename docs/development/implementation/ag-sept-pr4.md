...
case where nobody does.** The bound stays a bound, and each raise is a decision recorded in the
dashboard test that enforces it, which is where the graph counts and their reasons live.
