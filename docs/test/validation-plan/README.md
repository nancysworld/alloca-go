...
- [`ag-sept-pr4c-aws-probe.md`](ag-sept-pr4c-aws-probe.md) — deferred fixed-per-unit independent
  probe method; PR4c did not execute it and `VAL-SCALE-5` remains unproven.
