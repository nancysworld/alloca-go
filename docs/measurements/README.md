...
[`pr4a-rehearsal/`](pr4a-rehearsal/), which is `capacity`** — everything else
...
`pr4a-rehearsal/` cells are the worked example: they certify `capacity` and are
