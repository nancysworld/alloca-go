...
- [`ag-sept-plan-new.md`](ag-sept-plan-new.md) — **the current AG-Sept plan**: 19.5 development days, horizontal database authority before stateless replica scaling, no cloud path.
- [`ag-sept-plan-old.md`](ag-sept-plan-old.md) — superseded AG-Sept plan v0.4. Retained because PR1 and PR2 were planned and reported under it and cite its section numbers.
